                          ...
                          <table className="min-w-full divide-y divide-gray-300">
                            ...
                            <tbody className="bg-white divide-y divide-gray-300">
                              ...
                              <tr>
                               ...
                               <td className="px-6 py-4 whitespace-normal text-sm text-gray-700">{aggregateVitaData?.bpSys90DayAvg}</td>
                               <td className="px-6 py-4 whitespace-normal text-sm text-gray-700">{aggregateVitaData?.bpSys180DayAvg}</td>
                               <td className="px-6 py-4 whitespace-normal text-sm text-gray-700">{aggregateVitaData?.bpSys360DayAvg}</td>
                              </tr>
                              ...
                              <tr>
                               ...
                               <td className="px-6 py-4 whitespace-normal text-sm text-gray-700">{aggregateVitaData?.bpDia90DayAvg}</td>
                               <td className="px-6 py-4 whitespace-normal text-sm text-gray-700">{aggregateVitaData?.bpDia180DayAvg}</td>
                               <td className="px-6 py-4 whitespace-normal text-sm text-gray-700">{aggregateVitaData?.bpDia360DayAvg}</td>
                              </tr>

                              {/* Trends */}
                              <tr>
                                <td className="px-4 py-2 font-medium text-gray-700">Trends</td>
                               <td className="px-6 py-4 whitespace-normal text-sm text-gray-700">{aggregateVitaData?.bpSys1DayTrend || "-"}</td>
